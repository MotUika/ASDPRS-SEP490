...
namespace ASDPRS_SEP490.Controllers
{
    ...
    public class SearchController : ControllerBase
    {
        ...
        [SwaggerResponse(200, "Thành công", typeof(BaseResponse<SearchResultResponse>))]
        ...
        public async Task<IActionResult> Search([FromQuery] string query)
        {
            ...
            {
                return BadRequest(new BaseResponse<SearchResultResponse>("Query required", StatusCodeEnum.BadRequest_400, null));
            }
