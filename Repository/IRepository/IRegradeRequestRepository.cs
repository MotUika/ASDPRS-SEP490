...
namespace Repository.IRepository
{
    public interface IRegradeRequestRepository : IBaseRepository<RegradeRequest>
    {
        ...
        Task<IEnumerable<RegradeRequest>> GetByInstructorIdAsync(int requestId);
        ...
        Task<RegradeRequest> UpdateRequestStatusAsync(int requestId, string status, string resolutionNotes, int? reviewedByInstructorId, int? reviewedByUserId);
        Task<bool> HasPendingRequestForSubmissionAsync(int submissionId);
        Task<RegradeRequest> GetByIdAsync(int requestId);
        Task<RegradeRequest> GetByIdWithInstructorAsync(int requestId);
    }
}